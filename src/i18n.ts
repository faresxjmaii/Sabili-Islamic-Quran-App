...
const translations = {
  en: {
    ...
    riwayatQaloun: 'Riwayat Qaloun',
    searchSurah: 'Search Surah',
    searchHizb: 'Search Hizb number or Juz',
    lastRead: 'Last Read',
    fullReader: 'Riwayat Qaloun - Full reader',
    ...
    qalounDesc: 'Qaloun on Nafi al-Madani',
    quranDesc: 'Browse all 114 Surahs or the full 60 Hizb. Reader pages load the complete Arabic text from the Qaloun dataset with a dedicated Quran font.',
  ...
  ar: {
    ...
    riwayatQaloun: 'رواية قالون',
    searchSurah: 'ابحث عن سورة',
    searchHizb: 'ابحث عن الحزب أو الجزء',
    lastRead: 'آخر قراءة',
    fullReader: 'رواية قالون - قارئ كامل',
    allSurahs: 'كل السور',
    meccan: 'مكية',
    medinan: 'مدنية',
    hizb60: '60 حزب',
    ...
    qalounDesc: 'قالون عن نافع المدني',
    quranDesc: 'تصفح السور كلها أو الأحزاب الستين. صفحات القراءة تعرض النص العربي الكامل برواية قالون مع خط قرآني مخصص.',
  ...
  it: {
    ...
    fullReader: 'Riwayat Qaloun - Lettore completo',
    ...
    qalounDesc: 'Qaloun da Nafi al-Madani',
    quranDesc: 'Sfoglia tutte le 114 sure o i 60 Hizb. Le pagine caricano il testo arabo completo dal dataset Qaloun con un font coranico dedicato.',
